...
static struct sm5705_charger_oper_table_info sm5705_charger_operation_mode_table[] = {
	...
	{ make_OP_STATUS(0,1,1,0,1,0), SM5705_CHARGER_OP_MODE_USB_OTG, BST_OUT_5100mV, OTG_CURRENT_500mA},
	{ make_OP_STATUS(0,0,1,0,1,0), SM5705_CHARGER_OP_MODE_USB_OTG, BST_OUT_5100mV, OTG_CURRENT_500mA},
};
